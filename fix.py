...
part1_split = content.split('  const handleAddCustomSubject = () => {\n    if (customSubject.trim() && !selectedSubjects.includes(customSubject.trim())) {\n      setSelectedSubjects([...selectedSubjects, customSubject.trim()]);\n      setCustomSubject(\'\');\n    }\n  };\n')
part1 = part1_split[0] + '  const handleAddCustomSubject = () => {\n    if (customSubject.trim() && !selectedSubjects.includes(customSubject.trim())) {\n      setSelectedSubjects([...selectedSubjects, customSubject.trim()]);\n      setCustomSubject(\'\');\n    }\n  };\n\n'

part2_split = re.split(r'                  grades\[key\] = value;\n                }\n              }', content)
part2 = '\n                }\n              }' + part2_split[1]

inserted_code = '''  const handleSaveSubjects = () => {
    if (!subjectMajor) {
